...
def set_rules(multiworld: MultiWorld, world: World, options: PTOptions, toppins: int):
    ...
    #Tutorial
        ...
        "Tutorial Complete in under 2 minutes": "SLAM+SJUMP+GRAB",
    ...
    #Peppibot Factory
        "Peppibot Factory Complete": "SJUMP+CLIMB+SLAM",
        "Peppibot Factory Mushroom Toppin": "SJUMP",
        "Peppibot Factory Cheese Toppin": "SJUMP+CLIMB",
        "Peppibot Factory Tomato Toppin": "SJUMP+CLIMB",
        "Peppibot Factory Sausage Toppin": "SJUMP+CLIMB",
        "Peppibot Factory Pineapple Toppin": "SJUMP+CLIMB+SLAM",
        "Peppibot Factory Secret 1": "SJUMP",
        "Peppibot Factory Secret 2": "SJUMP+CLIMB+UPPER",
        "Peppibot Factory Secret 3": "SJUMP+CLIMB+SLAM",
        "Peppibot Factory Treasure": "SJUMP+CLIMB+SLAM",
        "Chef Task: There Can Be Only One": "SJUMP+CLIMB+SLAM",
        "Chef Task: Whoop This!": "SJUMP",
        "Chef Task: Unflattening": "SJUMP+CLIMB+SLAM",
    ...
    #Tutorial
        "Tutorial Complete": "SLAM+CLIMB+GRAB",
        "Tutorial Complete in under 2 minutes": "SLAM+CLIMB+GRAB",
        "Tutorial Mushroom Toppin": "SLAM",
        "Tutorial Cheese Toppin": "SLAM+CLIMB",
        "Tutorial Tomato Toppin": "SLAM+CLIMB",
        "Tutorial Sausage Toppin": "SLAM+CLIMB",
        "Tutorial Pineapple Toppin": "SLAM+CLIMB+GRAB",
    ...
    #Gnome Forest
        ...
        "Gnome Forest Tomato Toppin": "CRUSH",
        "Gnome Forest Sausage Toppin": "CRUSH",
        "Gnome Forest Pineapple Toppin": "CRUSH",
        "Gnome Forest Secret 1": "CRUSH",
        "Gnome Forest Secret 2": "CRUSH",
    ...
    #Freezerator
        ...
        "Chef Task: Season's Greetings": "STAUNT",
    ...
    #WAR
        ...
        "WAR Pineapple Toppin": "GRAB+SJUMP | UPPER+SJUMP | GRAB+SLAM | UPPER+SLAM",
        ...
        "Chef Task: Trip to the Warzone": "GRAB+SJUMP+SLAM | GRAB+SJUMP+TORN | GRAB+SJUMP+BOUNCE | UPPER+SJUMP+SLAM | UPPER+SJUMP+TORN | UPPER+SJUMP+BOUNCE",
        "Chef Task: Sharpshooter": "GRAB+SJUMP+SLAM | GRAB+SJUMP+TORN | GRAB+SJUMP+BOUNCE | UPPER+SJUMP+SLAM | UPPER+SJUMP+TORN | UPPER+SJUMP+BOUNCE",
        "Chef Task: Decorated Veteran": "GRAB+SJUMP+SLAM | GRAB+SJUMP+TORN | GRAB+SJUMP+BOUNCE | UPPER+SJUMP+SLAM | UPPER+SJUMP+TORN | UPPER+SJUMP+BOUNCE",
    ...
    #Gnome Forest
        "Gnome Forest Complete": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Gnome Forest Mushroom Toppin": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Gnome Forest Cheese Toppin": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Gnome Forest Tomato Toppin": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Gnome Forest Sausage Toppin": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Gnome Forest Pineapple Toppin": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Gnome Forest Secret 1": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Gnome Forest Secret 2": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Gnome Forest Secret 3": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Gnome Forest Treasure": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
        "Chef Task: Bee Nice": "TAUNT",
        "Chef Task: Bullseye": "TAUNT",
        "Chef Task: Lumberjack": "SLAM+SJUMP | SLAM+BOUNCE | CRUSH+SJUMP | CRUSH+BOUNCE | TORN+SJUMP | TORN+BOUNCE",
    ...
    #Peppibot Factory
        ...
        "Peppibot Factory Secret 3": "SJUMP",
